...
forval ii = 1/10{
	...
	* treatment group2
	gen byte C2G3_men = 1 if A1==1 & sex==1 & T3==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	gen byte C2G4_men = 1 if A1==1 & sex==1 & T4==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	gen byte C2G5_men = 1 if A1==1 & sex==1 & T5==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	
	gen byte C2G3_women = 1 if A1==1 & sex==2 & T3==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	gen byte C2G4_women = 1 if A1==1 & sex==2 & T4==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	gen byte C2G5_women = 1 if A1==1 & sex==2 & T5==1 & FEyP1== 1 & FEyP2== 1 & mass_layoff_indic ==1
	...
	gen byte C2G_men =1 if C2G3_men==1 | C2G4_men==1 | C2G5_men==1
	gen byte C2G_women =1 if C2G3_women==1 | C2G4_women==1 | C2G5_women==1

	keep if CG_men==1 | CG_women==1 | TG_men==1 | TG_women==1 | C2G_men ==1 |C2G_women ==1
